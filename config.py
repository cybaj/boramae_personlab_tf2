...
class config:
    ...
    # Epoch_sizes
    NUM_EPOCHS_SIZE = 1000
    
    # Where to save the coco2017 dataset
    # for validation
    VALID_ANNO_FILE = '../dataset/coco2017/annotations/person_keypoints_val2017.json'
    VALID_IMG_DIR = '../dataset/coco2017/val2017'
    # for train
    TRAIN_ANNO_FILE = '../dataset/coco2017/annotations/person_keypoints_train2017.json'
    TRAIN_IMG_DIR = '../dataset/coco2017/train2017'
    ...
    LOG_SCALAR_INTERVAL = 100
    LOG_IMAGE_INTERVAL = 100

    # checkpoint path
    CHECKPOINT_PATH = '../ckpt/'

    EVAL_TARGET_CATEGORY_ID = 1

    TARGET_ID_IN_BATCH = 0
    RAW_ID_IN_BATCH = 0
    KP_MAP_ID = 0
    SHORT_MAP_ID = 1
    MID_MAP_ID = 2
